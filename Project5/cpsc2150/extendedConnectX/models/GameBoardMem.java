...
public class GameBoardMem extends AbsGameBoard implements IGameBoard {
     ...
     *            MIN_NUMTOWIN < numWin < MAX_NUMTOWIN
     *            [GameBoard HashMap have no gaps between tokens]
     *
     * @Correspondence self = [GameBoard HashMap of characters at the selected boardPosition from column 0 to column 10] AND
     ...
     *
     * @param r number of rows on the game board
     * @param c number of columns on the game board
     * @param n number of consecutive tokens needed to win the game
     *
